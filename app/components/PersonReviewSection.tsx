...
function StarPicker({ value, onChange, disabled }: { value: number | null; onChange: (n: number | null) => void; disabled: boolean }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      {stars.map(s => (
        <button
          ...
          style={{
            ...
            color: value != null && s <= value ? 'var(--fm-star)' : 'var(--fm-text-muted)',
      ...
      <span style={{ fontSize: 12, color: 'var(--fm-text-muted)', marginLeft: 6 }}>
